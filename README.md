...
In order to try the application, you should follow the instruction of our [install](https://gitlab.coko.foundation/editoria/editoria/blob/update-readme/INSTALL.md) document. Also, for any question you could check if there is already an answer in our [FAQ](https://gitlab.coko.foundation/editoria/editoria/blob/update-readme/FAQ.md) document.
